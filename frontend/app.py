...
def get_additional_info(selected_id):    
        ...
        try:
            ...
            return res_model_data["hf_data"], res_model_data["config_data"], res_model_data["architectures"], res_model_data["model_id"], res_model_data["size"], res_model_data["gated"]
...
def gr_load_check(selected_model_id,selected_model_architectures,selected_model_pipeline_tag,selected_model_transformers,selected_model_private,selected_model_gated):
    ...
    if selected_model_architectures not in vllm_supported_architectures:
